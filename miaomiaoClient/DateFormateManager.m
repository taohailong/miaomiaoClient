...
-(int)figreOutIntervalMinuteSinceNowWithTime:(NSString*)time
{
    NSDate*compareDate = [self getDateFromString:time];
    long seconds = [[NSDate date] timeIntervalSinceDate:compareDate];
